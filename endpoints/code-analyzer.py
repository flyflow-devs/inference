...
stub = modal.Stub("code-analyzer-v1")
...
@stub.cls(
    ...
    container_idle_timeout=90000,
)
class ChatCompletions:
    def __init__(self, model_name: str = "axo-2024-04-21-20-23-48-129b/lora-out/merged") -> None:
    ...
    @modal.web_endpoint(method="POST", label="code")
